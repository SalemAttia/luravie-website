        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                    <div>
                        <h1 className="text-4xl font-bold text-teal">{activeCategory === 'Favorites' ? 'Your Wishlist' : 'Our Collection'}</h1>
                        <p className="text-teal/60">Premium comfort for your daily life.</p>
                    </div>
                    <div className="flex gap-4">
                        ...
                        <button
                            ...
                            className="px-5 py-3 bg-blush border border-teal/10 rounded-2xl text-sm font-bold flex items-center gap-2"
                        >
