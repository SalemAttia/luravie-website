      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-sm bg-blush shadow-2xl z-[70] overflow-hidden flex flex-col"
          >
            <div className="p-6 border-b border-teal/10 flex justify-between items-center">
              <div>
                <h2 className="text-xl font-bold text-teal">Filters</h2>
                <p className="text-xs text-teal/60 font-medium">Refine your selection</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10">
              {/* Sort By */}
              <section>
                <h3 className="text-xs font-bold text-teal/40 uppercase tracking-[0.2em] mb-4">Sort By</h3>
              ...
              {/* Sizes */}
              <section>
                <h3 className="text-xs font-bold text-teal/40 uppercase tracking-[0.2em] mb-4">Sizes</h3>
              ...
              {/* Colors */}
              <section>
                <h3 className="text-xs font-bold text-teal/40 uppercase tracking-[0.2em] mb-4">Colors</h3>
            ...
            <div className="p-6 bg-white border-t border-teal/5 flex gap-4">
              <button
                onClick={clearAll}
