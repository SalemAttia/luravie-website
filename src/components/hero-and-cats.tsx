      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
          <div>
            ...
            <h2 className="text-5xl font-bold text-teal mb-3 tracking-tighter">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 flex justify-between items-center text-white">
                <div>
                  ...
                  <span className="text-2xl font-bold">{tCommon(`categories.${cat.name.toLowerCase()}`)}</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-16 pt-12 border-t border-white/10">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-4xl font-bold text-rose">{locale === 'ar' ? 'فخامة' : 'Premium'}</span>
                <span className="text-[10px] font-bold text-white/40 uppercase tracking-[0.3em]">
