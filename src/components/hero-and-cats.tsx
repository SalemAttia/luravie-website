    ...
    <section className="py-24 bg-blush">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
          <div>
            <span className="text-teal font-bold tracking-[0.4em] text-[10px] uppercase mb-4 block opacity-40">The Collections</span>
            <h2 className="text-5xl font-bold text-teal mb-3 tracking-tighter">Essential Silhouettes</h2>
            <p className="text-teal/50 text-xl font-light">Elegance in every layer.</p>
          </div>
          <button
          ...
          >
            Explore all items <ArrowRight size={20} />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {CATEGORIES.map((cat, idx) => (
            <motion.div
              ...
              className="relative aspect-[3/4] rounded-[2rem] overflow-hidden group cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500"
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 flex justify-between items-center text-white">
                <div>
                  <p className="text-xs font-bold tracking-widest uppercase mb-1 opacity-80">Collection</p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-[9rem] font-bold text-white leading-[0.85] tracking-tighter">
              Confident <br />
              <span className="text-rose italic font-serif font-light">Inside.</span>
            </h1>

            <p className="text-2xl text-white/70 leading-relaxed max-w-xl font-light">
              We believe true confidence starts with how you feel. Discover premium fabrics designed for your everyday comfort and absolute privacy.
            </p>

            <div className="flex flex-wrap gap-8 pt-4">
              <button
                onClick={onShopNow}
                className="group px-12 py-6 bg-coral text-white rounded-[2rem] font-bold text-xl shadow-[0_20px_50px_rgba(234,123,123,0.3)] hover:shadow-[0_25px_60px_rgba(234,123,123,0.4)] hover:-translate-y-1 active:translate-y-0 transition-all flex items-center gap-4 cursor-pointer"
              >
                Shop Collection
              ...
              <button
                ...
                className="px-12 py-6 bg-white/5 text-rose rounded-[2rem] font-bold text-xl border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all cursor-pointer"
              >
                Our Values
              </button>
            </div>
            ...
            <div className="flex items-center gap-16 pt-12 border-t border-white/10">
              <div className="flex flex-col gap-1">
                <span className="text-4xl font-bold text-rose">100%</span>
                <span className="text-[10px] font-bold text-white/40 uppercase tracking-[0.3em]">Discreet</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-4xl font-bold text-rose">Premium</span>
                <span className="text-[10px] font-bold text-white/40 uppercase tracking-[0.3em]">Silk & Cotton</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            {/* Main Visual Frame */}
            <div className="relative aspect-[4/5] rounded-[4rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] border-[12px] border-white/5 backdrop-blur-3xl">
              <ImageWithFallback
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-10 bg-white p-8 rounded-[2.5rem] shadow-2xl border border-teal/5 hidden sm:block"
            >
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-lg font-bold text-teal">Superior Comfort</p>
                  <p className="text-xs font-bold text-coral uppercase tracking-widest">Premium Silk</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
